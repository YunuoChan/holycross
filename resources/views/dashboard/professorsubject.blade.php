        ...
        <div class="mb-4 d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-center flex-column mb-0">
                <div class="input-group">
                    <input type="text" class="form-control" id="searchField-professorsubject" placeholder="Search.." aria-label="Search.." aria-describedby="basic-addon2">
                    <div class="input-group-append">
                      <button class="btn btn-outline-secondary" id="searchBtn-professorsubject" type="button"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </div>
        </div>
